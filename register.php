...
{  
    ...
    $query = "INSERT into `accounts` (username, first_name, last_name, answer, secret_question, password)
...
?>
        <form class="box" action="" method="post">
            ...
            <input type="text" class="box-input" name="prenom" placeholder="prenom" required />
             ...
             <label for="secret_question">Choisir une question secrete: </label><select name="question" id="secret_question">
